...
int encode_one_frame (VideoParameters *p_Vid, InputParameters *p_Inp)
{
  ...
  */
  ...
  //modified by Lindan
 // JudgeforSkipInter(p_Vid);
  //memcpy(PreviousOriginalFrame[0][0], p_Vid->imgData0.frm_data[0][0], p_Vid->imgData0.format.height[0] * p_Vid->imgData0.width[0] * sizeof (imgpel));
